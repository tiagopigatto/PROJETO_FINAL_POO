...
\item\contentsline{section}{\hyperlink{class_basic_type}{Basic\-Type} \\*Essa e a classe responsavel por ser um padrao de classe para clases tipos basicos \par
 tendo os metodos obrigratorios para todas essas e os mentodos mais gerais ja implemtados\par
 inline garantindo uma economia de memoria }{\pageref{class_basic_type}}{}
...
\item\contentsline{section}{\hyperlink{class_coment}{Coment} \\*Essa e a classe que repensenta os cometarios dos Usuarios nos posts no contexto do Sistema }{\pageref{class_coment}}{}
...
\item\contentsline{section}{\hyperlink{class_coment_text}{Coment\-Text} \\*Essa e a classe responsavel por represnetar os textos do comentarios no contexto do sistema }{\pageref{class_coment_text}}{}
...
\item\contentsline{section}{\hyperlink{class_command_find_coment}{Command\-Find\-Coment} \\*Classe que irá procurar um cometário pelo id, se encontrar o coloca em um objeto \hyperlink{class_coment}{Coment} }{\pageref{class_command_find_coment}}{}
\item\contentsline{section}{\hyperlink{class_command_find_post}{Command\-Find\-Post} \\*Classe que irá procurar um post pelo id, se encontrar o coloca em um objeto \hyperlink{class_post}{Post} }{\pageref{class_command_find_post}}{}
\item\contentsline{section}{\hyperlink{class_command_find_post_coments}{Command\-Find\-Post\-Coments} \\*Classe que irá procurar os comentários de um post, se encontrar os coloca em um lista de objetos \hyperlink{class_coment}{Coment} }{\pageref{class_command_find_post_coments}}{}
...
\item\contentsline{section}{\hyperlink{class_date}{Date} \\*Essa e a classe responsavel por reprensentar as datas do sistema }{\pageref{class_date}}{}
...
\item\contentsline{section}{\hyperlink{class_evaluation}{Evaluation} \\*Essa e a classe responsavel por reprensentatar as avaliaçaoes geradas pelos usuarios para determinada classe }{\pageref{class_evaluation}}{}
...
\item\contentsline{section}{\hyperlink{class_identify}{Identify} \\*Essa e a classe responsavel por representar os identificadores dos termos no sistema }{\pageref{class_identify}}{}
...
\item\contentsline{section}{\hyperlink{class_password}{Password} \\*Essa e a classe responsavel por resprendentar a senha do usuario no sistema }{\pageref{class_password}}{}
...
\item\contentsline{section}{\hyperlink{class_post}{Post} \\*Essa e a classe que repensenta os post dos Usuarios no contexto do Sistema }{\pageref{class_post}}{}
...
\item\contentsline{section}{\hyperlink{class_post_text}{Post\-Text} \\*Essa e a classe responsavel por reprensentar os textos dos posts no contexto do sistema }{\pageref{class_post_text}}{}
...
\item\contentsline{section}{\hyperlink{class_star_teste_tipos}{Star\-Teste\-Tipos} }{\pageref{class_star_teste_tipos}}{}
...
\item\contentsline{section}{\hyperlink{class_teste_basico}{Teste\-Basico} \\*Classe que contem o tipo basico para realizar os testes, estes serão herdados por outras classes }{\pageref{class_teste_basico}}{}
\item\contentsline{section}{\hyperlink{class_teste_t_b_coment_text}{Teste\-T\-B\-Coment\-Text} \\*Classe que herda a classe \hyperlink{class_teste_basico}{Teste\-Basico} e realiza os testes do tipo básico Comment }{\pageref{class_teste_t_b_coment_text}}{}
\item\contentsline{section}{\hyperlink{class_teste_t_b_date}{Teste\-T\-B\-Date} \\*Classe que herda a classe \hyperlink{class_teste_basico}{Teste\-Basico} e realiza os testes do tipo básico \hyperlink{class_date}{Date} }{\pageref{class_teste_t_b_date}}{}
\item\contentsline{section}{\hyperlink{class_teste_t_b_evaluation}{Teste\-T\-B\-Evaluation} \\*Classe que herda a classe \hyperlink{class_teste_basico}{Teste\-Basico} e realiza os testes do tipo básico Avalia }{\pageref{class_teste_t_b_evaluation}}{}
\item\contentsline{section}{\hyperlink{class_teste_t_b_identify}{Teste\-T\-B\-Identify} \\*Classe que herda a classe \hyperlink{class_teste_basico}{Teste\-Basico} e realiza os testes do tipo básico Ident }{\pageref{class_teste_t_b_identify}}{}
\item\contentsline{section}{\hyperlink{class_teste_t_b_password}{Teste\-T\-B\-Password} \\*Classe que herda a classe \hyperlink{class_teste_basico}{Teste\-Basico} e realiza os testes do tipo básico Senha }{\pageref{class_teste_t_b_password}}{}
\item\contentsline{section}{\hyperlink{class_teste_t_b_post_text}{Teste\-T\-B\-Post\-Text} \\*Classe que herda a classe \hyperlink{class_teste_basico}{Teste\-Basico} e realiza os testes do tipo básico \hyperlink{class_post}{Post} }{\pageref{class_teste_t_b_post_text}}{}
\item\contentsline{section}{\hyperlink{class_teste_t_b_user_name}{Teste\-T\-B\-User\-Name} \\*Classe que herda a classe \hyperlink{class_teste_basico}{Teste\-Basico} e realiza os testes do tipo básico Nome\-Usuario }{\pageref{class_teste_t_b_user_name}}{}
...
\item\contentsline{section}{\hyperlink{class_user}{User} \\*Esse e a classe Usuario que reprenta o usuario no contexto deste sistema }{\pageref{class_user}}{}
...
\item\contentsline{section}{\hyperlink{class_user_name}{User\-Name} \\*Essa e a classe responsavel reprensentar o nome do ususario no sistema }{\pageref{class_user_name}}{}
