...
void UserControler::showList()
{
    ...
    for (std::list<User>::iterator it=mylist.begin(); it != mylist.end(); ++it)
    {
        cout << "Usuario: ";
        cout << (*it.getName()).getValue() << endl;
        cout << "Com numero de ID: ";
        cout << (*it.getIdentify()).getValue() << endl;
    }
}
...
void PostControler::listaMeus()
{
    ...
    for (std::list<Post>::iterator it=mylist.begin(); it != mylist.end(); ++it)
    {
        cout << "Postagem do usuario: ";
        cout << (*it.getAuthorIdentify()).getValue() << endl;
        cout << "ID da postagem: ";
        cout << (*it.getPostIdentify()).getValue() << endl;
        cout << "Postado no dia: ";
        cout << (*it.getDate()).getValue() << endl;
        cout << "Avaliacao do post: ";
        cout << (*it.getEvaluation()).getValue() << endl;
    }
}
...
void ComentControler::cria()
{
    ...
    while (1)
    {
        ...
        coment.getAuthorIdentify(user.getIdentify());
        coment.getPostIdentify(post.getPostIdentify());
        coment.setComentIdentify(ident);
        coment.setComentText(comentext);
        coment.setDate(date);
...
void ComentControler::lista()
{
    ...
    for (std::list<Coment>::iterator it=mylist.begin(); it != mylist.end(); ++it)
    {
        ...
        cout << (*it.getComentIdentify()).getValue() << endl;
